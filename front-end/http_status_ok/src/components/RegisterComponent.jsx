...
const RegisterComponent = () => {
    ...
    function handleRegistrationForm(e){
        ...
        if (isUsernameValid && isUsernameValid && isEmailValid && isPasswordValid && isRepeatPasswordValid) {
...
<ToastContainer>
        ...
        <div className='logo-1'><img src={img2} alt="" /></div>
        <div className='logo-2'><img src={img3} width={400} alt="" /></div>
                    ...
                    <div className='card-body'>
                            <form>
                                <div className='row mb-3'>
                                        ...
                                        <div>
                                            <input type='text' 
                                             ...
                                             />
                                             {nameEmptyError && <p className="text-danger">{nameEmptyError}</p>}
                                        </div>
                                </div>
                                <div className='row mb-3'>
                                        <label className='col-md-7 control-label'></label>
                                ...
                                <div className='form-group mb-2'>
                                    <button className="px-5 py-2 rounded-3 col-12 justify-content-center align-items-center
                                                      " id='custom-button'onClick={(e) => handleRegistrationForm(e)}>Create an account</button>
                                                
                                </div>
                                <div className='Allready-member'><p>Allready a member ?</p></div>
