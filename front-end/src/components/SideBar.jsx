...
export const SideBar = () =>{
    ...
    <a href="/" className="d-flex align-items-center pb-3 mb-3 link-body-emphasis text-decoration-none">
      <span className="fw-semibold" style={{fontSize:"20px", color:"white", backgroundColor:"rgba(119, 73, 248, 0.50)", width:"217px", height:"56px", paddingLeft:"16px", paddingTop:"13px"}}>Sidebar</span>
    </a>
      ...
      <li className="mb-1">
        ...
        <div className="collapse" id="account-collapse">
          <ul className="btn-toggle-nav list-unstyled fw-normal pb-1 small">
            ...
            <li><a href="#" className="link-body-emphasis d-inline-flex text-decoration-none rounded" style={{marginLeft:"15px"}}>Sign out</a></li>
          </ul>
        </div>
      </li>
    </ul>
