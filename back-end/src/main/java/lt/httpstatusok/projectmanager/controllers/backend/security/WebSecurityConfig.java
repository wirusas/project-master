    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
                .authorizeHttpRequests(authorizeHttpRequests -> authorizeHttpRequests
                        ...
                        .requestMatchers(HttpMethod.DELETE, "/api/projects/{projectId}/removeUser/{userEmail}").hasAnyAuthority(ADMIN, USER)
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/projects/{projectId}/tasks/csv").hasAnyAuthority(ADMIN, USER)
                        ...
                        .requestMatchers("/api/projects").hasAnyAuthority(ADMIN, USER)
